...
> **Extensão do Módulo Email — Agendamento de envio (US-1.9–1.11):** agendar/listar/cancelar envios diferidos, reaproveitando a Fase 1 (two-phase, anexos grandes draft→send) e sem novos scopes. Detalhe em [docs/fase-email-scheduling/analise-funcional-agendamento.md](fase-email-scheduling/analise-funcional-agendamento.md).
